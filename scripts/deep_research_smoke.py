...
def main() -> None:
    ...
    _require("Deep Research Agents" in detailed[9], "research tab did not render agent findings")
    _require("Ran deep research agents" in detailed[8], "trace tab did not explain research agents")
